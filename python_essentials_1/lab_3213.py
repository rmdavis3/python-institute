...
He wants everyone who runs his program to play the Guess the secret number game, and guess what 
...
Your task is to help the magician complete the code in the editor in such a way so that the code:
    ...
    * will check whether the number entered by the user is the same as the number picked by the 
    ...
    a number again. If the number entered by the user matches the number picked by the magician, 
